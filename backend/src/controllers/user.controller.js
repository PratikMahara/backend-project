...
const loginUser= asyncHandler( async(req,res)=>{
    //input from the user
    // validate the inputs
    //check whether the password and userid is correct or not
    //if userid and password is valid then give the permission to access
    //access and refresh token send through cookies
...
const video=await Video.create({
  ...
  thumbnailPath: thumbnailPath.url
